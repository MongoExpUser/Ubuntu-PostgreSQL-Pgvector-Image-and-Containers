...
RUN sudo -H python3 -m pip install pg8000 psycopg-binary psycopg_pool sb-json-tools jupyterlab jupyterlab-night pyiceberg pyarrow psycopg2-binary sqlalchemy
